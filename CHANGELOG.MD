...
9. 新增 集卡 活动
10. 新增 SVIP 活动
11. 若当前版本已发布超过14天，则在标题栏中增加显示距离下个活动周期预计剩余的时间
12. 版本时间过久的保底提示中增加展示下次活动的预估时间信息
13. 运行结束的时候，增加列出未来一年内各种常规活动周期的预估时间信息
14. 配置工具标题栏也增加活动预估信息
15. 心悦兑换的神器装扮属性调整箱已被移除，做下对应处理
16. 移除过时的提示
