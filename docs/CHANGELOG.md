# 更新公告
1. 更新黑名单
2. 燃放爆竹查询好友有时候会无法成功，故而本地加个缓存，一次请求所有好友QQ列表，这样只要请求成功一次就够活动期间使用了
3. 新增付费获取的DLC：自动更新功能（未购买则保持与之前版本的更新流程一致）。目前定价10.24元，[演示视频](https://www.bilibili.com/video/BV1FA411W7Nq)，有需要的朋友可以扫码付款后QQ私聊我发付款截图获取自动更新工具0-0
4. 新增付费获取的集卡特别版DLC，仅包含集卡相关功能（集卡、送卡、展示卡片信息、兑换卡片奖励、使用卡片抽奖），供某些只需要集卡的朋友使用。定价6.66元，[演示视频](https://www.bilibili.com/video/BV1zA411H7mP)，有需求的朋友可以扫码付款后QQ私聊我发付款截图获取ヾ(=･ω･=)o
5. 本轮集卡我又换完啦，有需要买卡的朋友可私聊我购买~依旧是一元一张任意卡，先问下有没有卡，得到确定回复后直接发付款截图和要收卡片的QQ号码即可（不需要加好友）
