# 更新公告
1. 新春快乐~深渊神话闪闪闪，团本金牌冲冲冲！
2. 处理spinbox容易被滚轮误改动的问题，改为滚动不能focus，且未focus时不处理滚轮事件
3. 修复保存第二个账号会panic的问题
4. 鉴于这几天付费支持的朋友不少，因此特地花了不少时间，做了一个配置工具，各位可双击【DNF蚊子腿小助手配置工具.exe】进行体验（恰饭恰饱了才有力气干活.jpeg）
5. 如需购买自动更新DLC或按月付费，请查阅目录中【付费指引v20210209.docx】(日期可能随版本变动)
