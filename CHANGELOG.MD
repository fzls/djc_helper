...
2. 标题附加新版本提示改为异步处理，避免打开时卡住
3. 配置工具增加个人信息页面
4. 界面加几个按钮
5. 标题栏增加新版本提示
6. 调整助手登录态过期的判定方式
7. 处理spinbox容易被滚轮误改动的问题，改为滚动不能focus，且未focus时不处理滚轮事件
8. 修复保存第二个账号会panic的问题
9. 鉴于这几天付费支持的朋友不少，因此特地花了不少时间，做了一个配置工具，各位可双击【DNF蚊子腿小助手配置工具.exe】进行体验（恰饭恰饱了才有力气干活.jpeg）
10. 如需购买自动更新DLC或按月付费，请查阅目录中【付费指引v20210209.docx】(日期可能随版本变动)
