...
2. 按需下载chrome_driver，以应对强制设置chrome版本的情况
3. 当未找到合适版本的chrome时，尝试从网盘自动下载对应版本便携版压缩包（因为实在没想到在已经将原因和解决方法写的这么明确的情况下，还能有不少人连下载对应文件放到目录里也处理不来，唉，差点没把我气死）
4. 补充提示，指引强制修改chrome版本号
5. 默认配置不再兑换道聚城的疲劳药
6. 修复管家页面登录失败的问题
