...
def main():
    ...
    # note: 在这里添加公告
    title = "24.9 苏醒之森小游戏"
    message = """9.5游戏内新上线了个端内小游戏，完成后可以领取30天黑钻和一个变身药水，有兴趣的朋友可以按照下面的步骤去操作。

1. 在游戏内右下角活动图标区域找到一个小狐狸图标，点开后会弹出一个窗口【苏醒之森答题】
2. 依次点击左边的【攻略】，看每个一分钟左右的攻略视频，然后右侧的按钮来开始答题
3. 6个答题全部完成后，就可以在左上角领取30天黑钻。9.12之后还可以领取右上角的变身药水
"""
    open_url = ""
    show_only_before_version = ""
