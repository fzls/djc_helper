...
2. 若编年史有奖励未领取，且未配置token，则在满级或本月最后一天的时候提示手动领取
3. 调整查询付费信息时的提示语，提醒通过配置工具购买不需要私聊
4. 修复缓存功能bug导致不能及时更新付费信息的问题
5. 移除几个过期活动
6. 微信付款渠道已重新开放，取消按钮的点击提示
7. 修复无限提示skey过期且其他进程在登陆中的问题
8. 为修复上一个问题，重置本地运行统计数据，因此可能会重新弹出很多窗口
9. 更新付费指引中关于dlc的使用说明
