...
def main():
    ...
    # note: 在这里添加公告
    title = "手机号码验证v2"
    message = """5.35（你懂得）这个敏感日子要到了，所以最近好像QQ的风控严了很多。
上次有说最近很多人都出现了，刚刚我的各个QQ也全都出现这个提示了，经过我自己的亲身体验，这里总结下应对方法

1. 绑定自己手机的QQ
    一个个按提示发短信验证即可，好像短时间内不会再出现（不确定第二天是否会出现）
2. 其他人的QQ
    最近就不要帮别人托管账号了，让他们自己本地运行，这样方便按第一步自行处理验证码

小助手也将在v16.15.2及之后版本中增加检测该情况，当出现该情况时，会强制显示浏览器界面，并延迟操作最大等待时长到10分钟，确保有足够的的时间处理验证码~
"""
    open_url = ""
    show_only_before_version = ""
