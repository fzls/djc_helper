...
2. 新增心悦app G分脚本
3. 新增wegame积分脚本
4. 微信签到脚本增加新的微信签到活动：2020DNF嘉年华派送好礼
5. 抽取amesvr活动的通用构建逻辑，方便后续添加新活动，减少维护成本~
6. 增加wegame登录逻辑
7. 配置中关于获取助手token的注释，加上代码中给出的额外提示~
8. 额外加个不启用QQ空间登录的提示
9. readme页面增加声明
10. 调整助手信息的描述
11. 移除过期的 dnf助手排行榜 活动
12. 添加基于docsify的github pages页面
13. 增加检测助手userid的有效性
14. 增加指引auto.js相关脚本内容
