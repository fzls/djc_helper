# 更新公告
1. 新增DNF微信公众号答题活动，目前通过autojs脚本实现，有兴趣的小伙伴可以点目录中的autojs链接来了解使用
2. 长期检查更新失败的提示增加dlc用户无视的提示
3. 配置工具接入基于卡密付费的自助付费方案
4. 付费指引文档中增加卡密付费的图文教程
5. 修复配置工具添加新账号后，心悦战场相关操作默认不执行的问题
6. 修复若普通付费已到期的情况下，自动更新赠送的时长叠加后最终过期时间每天都会提前的问题
7. 增加在github action运行的yml，并在代码中特殊适配该环境（实际效果不好，因为主机在美国，网络访问基本全超时）
8. 新增带GUI的配置工具
9. 如需购买自动更新DLC或按月付费，请查阅目录中【付费指引v20210209.docx】(日期可能随版本变动)
