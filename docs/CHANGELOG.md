# 更新公告
1. 新增漫画活动抽奖开关（账号配置tab/其他），方便手动兑换完想要的奖励后开启
2. 根据ga4统计界面，调整上报的数据结构层级，方便一眼看出统计分布
3. 接入新的会员关怀活动
4. 更新漫画活动到14集
5. 当修改账号名时，根据之前的账号名，定位并同步修改tab名称
6. 调整按钮配色
7. 手游名称默认值改回任意
8. 默认配置增加一个未启用的二号配置，用于提示可以添加多个账号一起运行-。-
9. 尝试接入Google Analytics 4
