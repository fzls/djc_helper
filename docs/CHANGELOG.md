# 更新公告
1. 处理无存档时的情况
2. 特判没找到modRet的情况，提示可能是活动过期了
3. qq空间登录也需要获取skey后，若是旧版本存档，视作已过期
4. 重新启用福利兑换，并增加新的游戏签到活动
5. 增加 提示参与 万物皆新意 牛转阿拉德 活动
6. 新增wegame春节活动 新春献豪礼 首次盲盒限时领
7. 新增新春福袋大作战的邀请外内容
8. 移除过期的马杰洛活动
9. qq空间登录时额外保存skey、vuserid等信息，并优先进行qq空间登录。从而在检查skey的时候先尝试使用qq空间获取的skey，如果可用则能减少登陆次数
10. 新增捕获所有异常的装饰器，用于保护新加的活动，避免因新活动导致其他活动不可用
11. 新增付费获取的DLC：自动更新功能（未购买则保持与之前版本的更新流程一致）。目前定价10.24元，[演示视频](https://www.bilibili.com/video/BV1FA411W7Nq)，有需要的朋友可以扫码付款后QQ私聊我发付款截图获取自动更新工具0-0
12. 新增付费获取的集卡特别版DLC，仅包含集卡相关功能（集卡、送卡、展示卡片信息、兑换卡片奖励、使用卡片抽奖），供某些只需要集卡的朋友使用。定价6.66元，[演示视频](https://www.bilibili.com/video/BV1zA411H7mP)，有需求的朋友可以扫码付款后QQ私聊我发付款截图获取ヾ(=･ω･=)o
