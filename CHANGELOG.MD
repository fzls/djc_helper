# 更新公告
1. 新增qq视频-看江湖有翡活动
2. 额外说明一下未获取到token的链接的情况
3. 额外说明助手活动需要token
4. 新增付费获取的DLC：自动更新功能（未购买则保持与之前版本的更新流程一致）。目前定价10.24元，[演示视频](https://www.bilibili.com/video/BV1FA411W7Nq)，有需要的朋友可以扫码付款后QQ私聊我发付款截图获取自动更新工具0-0
