...
def main():
    ...
    # note: 在这里添加公告
    title = "新版心悦战场"
    message = """12.21更新的新版心悦战场现已全部接入，各位可在配置工具中配置使用，包括下列内容
1. 领取周常、月常礼包、返利勇士币
2. 使用成就点和勇士币兑换各种道具（需要在配置工具-心悦特权专区兑换中进行配置）
3. 荣耀镖局（包括3次运镖、抽奖、自动组队与本地组队）

由于适配本次心悦战场改版中，小助手这部分的内容几乎大改了一遍，所以请各位在最近使用小助手的时候，观察下这部分功能是否有异常，若有异常可在群中反馈，谢谢~

PS：请确保在活动开关中【没有禁用】心悦登录，否则心悦战场相关的功能将无法正常使用
"""
    open_url = ""
    show_only_before_version = ""
