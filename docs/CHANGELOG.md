# 更新公告
1. 更新 落地页签到 活动
2. 供qq机器人使用的下载脚本适配github release
3. !!! v19.0.0中的dlc有bug，购买了dlc的朋友们请确保下载的是v19.0.1及之后的版本 !!!
5. 修正dlc仍使用蓝奏云判定版本号而导致不能正常检查更新的问题
6. dlc增加敲击任意键来中断当前下载的功能
7. 因使用第三方封装的接口来上传和下载文件，导致蓝奏云账号被禁用上传功能，因此改用下面的腾讯云文档来发布新版本的下载地址
8. https://docs.qq.com/doc/DYmlqWGNPYWRDcG95
9. 本次为不兼容更新，之前的版本不能自动升级到新版本，请各位按照上面文档的流程下载新版本后使用
