...
3. 道聚城兑换时，若未绑定对应游戏的角色信息，则弹窗提示
4. 默认启用检查腾讯游戏接口401速度过快和504网关超时的情况，方便自动重试
5. 通过腾讯游戏接口查询角色信息加下缓存，避免请求过于频繁
6. 如需购买自动更新DLC或按月付费，请在配置工具的【付费相关】标签页自助购买，具体流程请查阅目录中【付费指引.docx】
