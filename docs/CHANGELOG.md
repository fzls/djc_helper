# 更新公告
1. 接入新的集卡活动 超萌雪人送祝福
2. qq空间登录完成后等待一会再刷新页面，避免处于未登录状态
3. 集卡概览改为只显示一次
4. 若调用自动更新工具能正常返回，则说明已是最新版本，增加提示说明
5. 增加提示短信验证的情况，提示关闭自动处理验证码功能
6. 增加蓝奏云挂了时的提示信息
7. 完善关闭特定登陆类型的描述
8. 增加qq视频在线30分钟失败的提示
9. autojs脚本增加支持基于QQ完成预购活动每日免费抽奖的逻辑，详见 [脚本](https://github.com/fzls/autojs/blob/main/qq.js)
10. 新增付费获取的DLC：自动更新功能（未购买则保持与之前版本的更新流程一致）。目前定价10.24元，[演示视频](https://www.bilibili.com/video/BV1FA411W7Nq)，有需要的朋友可以扫码付款后QQ私聊我发付款截图获取自动更新工具0-0
11. 新增付费获取的集卡特别版DLC，仅包含集卡相关功能（集卡、送卡、展示卡片信息、兑换卡片奖励、使用卡片抽奖），供某些只需要集卡的朋友使用。定价6.66元，有需求的朋友可以扫码付款后QQ私聊我发付款截图获取ヾ(=･ω･=)o
