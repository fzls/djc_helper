...
2. 卡密付费提示增加支持新的付费方案
3. 马杰洛小工具赠送时增加显示赠送结果
4. 更新bandizip版本，减少最终打包大小
5. 打包时增加使用upx的选项，进一步压缩打包大小
6. 编译前移除部分用不到的qt组件，减少配置工具的大小，并在编译完成后移动回来
7. （这次缩减大小也许会有兼容性问题，如果打不开请qq群@我反馈~）
8. 如需购买自动更新DLC或按月付费，请使用配置工具的卡密购买功能，具体流程请查阅目录中【付费指引v20210209.docx】(日期可能随版本变动)
