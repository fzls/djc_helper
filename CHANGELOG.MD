# 更新公告
1. 再说一遍，我爱啥时候更新啥时候更新，爱更新几次就更新几次，不喜欢就关闭检查更新，一个月手动去网盘看有没有更新。别一遍开着检查更新，一遍吐槽为啥更新这么频繁，好像强迫你更新了一样。
2. 修复小工具领取礼盒成功仍会提示繁忙的问题
3. 增加一个一键登录全部账号的按钮
4. socde允许填写scode或者直接整个url
5. 按钮增加步骤序号
6. 配置工具增加马杰洛小工具tab，方便进行礼盒的赠送和领取
7. 个人概览增加展示马杰洛赠送礼盒数目
8. 同步配置不再包含自动更新dlc
9. 接入马杰洛活动
10. 更新漫画活动集数
