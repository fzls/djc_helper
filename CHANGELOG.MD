...
14. 以下活动已知会有，但目前不知道网页链接，如发现可群里@我告知，包括：集合站、wegame、集卡、肥腙小游戏
15. 在设置了【无法绑定道聚城】时，强制打开【禁用大多数活动】的开关，避免在自动绑定阶段因为无法定位角色信息导致提示需要手动绑定，而又因为没有角色，实际也无法完成绑定
16. 提示手动绑定的窗口处也增加提示开启禁用活动开关
17. 配置工具付费界面的QQ的自动填充不再要求配置为自动登录，只需要配置了QQ即可
