    ...
    def _login(self, login_type, login_action_fn=None, login_mode="normal"):
        ...
        logger.warning(
            ...
            + (
                ...
                "1. 重新打开程序\n"
                "2. 重启电脑\n"
                "3. 切换旧版本chrome（如果之前都是正常的） - 配置工具/公共配置/登录/chrome版本，修改为94或者更早的版本\n"
        ...
        for idx in range_from_one(max_try):
            try:
                ...
                logger.error(
                    ...
                    + "\n"
                    + color("bold_cyan")
                    + "如果之前版本都是正常的，可以试试切换旧版本chrome - 配置工具/公共配置/登录/强制使用特定大版本chrome，修改为94或者更早的版本\n",
                    exc_info=e,
                )
