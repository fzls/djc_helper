# 更新公告
1. 兼容自动更新dlc在部分情况下无法查询最新版本的问题
2. 自动更新dlc增加从github和gitee获取最新版本的备选方案
3. 移除部分过期活动
4. （小广告）去年11月研究了一下青龙面板，可以白嫖京东的京豆和红包，可以溢价买QB，或者买各种东西。用了几个月，感觉还不错，有兴趣的朋友可以加小群 657921324 来一起白嫖（密码 风之凌殇）
