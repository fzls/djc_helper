# 更新公告
1. 各位新春快乐~深渊神话闪闪闪，团本金牌冲冲冲！
2. 配置工具增加个人信息页面
3. 界面加几个按钮
4. 标题栏增加新版本提示
5. 调整助手登录态过期的判定方式
6. 处理spinbox容易被滚轮误改动的问题，改为滚动不能focus，且未focus时不处理滚轮事件
7. 修复保存第二个账号会panic的问题
8. 鉴于这几天付费支持的朋友不少，因此特地花了不少时间，做了一个配置工具，各位可双击【DNF蚊子腿小助手配置工具.exe】进行体验（恰饭恰饱了才有力气干活.jpeg）
