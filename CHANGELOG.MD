# 更新公告
1. 2021新年快乐( • ̀ω•́ )✧
2. 检查未绑定账号时，将未绑定的账号列表打印出来
3. 修复闪光杯未报名时会出错的问题，并提示一下去报名
4. 更新抽卡结束时间
5. 修正多次登录出错时login_type会重复添加后缀信息的问题
6. 管家登录兼容下出验证码的情况
7. 移除运行成功时弹出打赏图片的功能和配置，仅保留每周首次运行的时候弹一次的功能
8. 添加自动更新所需的一些基础设施，为后续加入自动更新功能做准备
9. 推荐使用使用autojs来自动完成助手编年史中的助手app相关任务、微信签到和2020DNF嘉年华派送好礼、hello语音活动等目前小助手无法直接支持的流程
10. 具体操作可参考[脚本源码](https://github.com/fzls/autojs) 以及 [演示视频](https://www.bilibili.com/video/BV1az4y1k7bH/)
