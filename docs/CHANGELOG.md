...
2. 在清除登录状态时，增加提示多账号功能如何使用
3. chrome110版本部分人在win7似乎无法正常使用，改回107版本
4. chrome版本支持远程配置，方便在更新了chrome版本后发现部分系统无法正常使用时可以及时降级到之前的版本
5. 配置工具增加直接设置领奖角色的功能，从而可以在不依赖道聚城的情况下，也能照常获取绑定角色信息
6. 云配置可配置指定版本前无视权限在最开头进行自动更新的配置，从而在出现一些严重bug时，可正常更新到已修复的最新版本，不会被登录等流程拦住
