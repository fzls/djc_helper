...
class Urls:
    def __init__(self):
        ...
        self.iActivityId_maoxian = "485630"  # 勇士的冒险补给
        ...
        self.dnf_helper_chronicle_wang_xinyue = (
            "https://mwegame.qq.com/peak/{api}?userId={userId}&gameId=1006&sPartition={sPartition}&sRoleId={sRoleId}&game_code=dnf&token={token}&uin={uin}&toUin={toUin}&uniqueRoleId={uniqueRoleId}"
            "&isLock={isLock}&amsid={amsid}&iLbSel1={iLbSel1}&num={num}&mold={mold}&exNum={exNum}&iCard={iCard}&iNum={iNum}&appidTask=1000042&&date={date}&accessToken={accessToken}&appOpenid={appOpenid}&appid={appid}"
        )
