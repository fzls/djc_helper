...
2. 重新启用福利兑换，并增加新的游戏签到活动
3. 增加 提示参与 万物皆新意 牛转阿拉德 活动
4. 新增wegame春节活动 新春献豪礼 首次盲盒限时领
5. 新增新春福袋大作战的邀请外内容
6. 移除过期的马杰洛活动
7. qq空间登录时额外保存skey、vuserid等信息，并优先进行qq空间登录。从而在检查skey的时候先尝试使用qq空间获取的skey，如果可用则能减少登陆次数
8. 新增捕获所有异常的装饰器，用于保护新加的活动，避免因新活动导致其他活动不可用
