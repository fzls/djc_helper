...
3. 增加检测 安全验证 的情况
4. 适配新版登录滑动验证码（感谢提供测试qq的 LLL/呵/Serendipity 等群友~）
5. 新版滑动验证码的精度提高，废弃原有配置项，并将新的配置项改为原有值的一半
6. 调整登录默认样式
7. 当拥有光环时，增加兑换光环
8. 小屋增加社交授权参数
9. 我的小屋查询好友需要获取pskey
10. 小屋增加记录第几页出现的稀有奖励，方便找到好友
11. 由于心悦集卡的14价格过高，取消自动兑换天三，由用户自行决定（虽然很久没人抽到过了<_<）
12. 配置工具增加补充说明【禁用绝大部分活动】的例外情况
13. 调整绑定账号的提示文字，更加容易理解
14. 将助手token改为指引查看在线文档，避免同时维护多个地方
