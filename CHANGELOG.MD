...
3. 增加魔界人跳一跳的提示
4. 增加虎牙斗鱼的活动提示
5. 修复扫码登录 腾讯爱玩 时，登录成功后会因NoSuchWindowException而出错的问题
6. 兼容腾讯爱玩登录失败时，已经切换到iframe的情况
7. 爱玩登录失败时，增加提示如何关闭
8. 新增 colg签到 活动
9. 新增 DNF助手专属活动（异界回归） 活动
10. 新增 DNF集合站 活动
11. 新增 wegame 活动
12. 新增 管家蚊子腿 活动
13. 新增 超级会员 活动
14. 新增 黄钻 活动
15. 新增 魔界人探险记 活动
16. 新增 马杰洛 活动（邀请需要自行完成）
17. 新增 组队拜年 活动（组队和邀请自行完成）
18. 新增 集卡 活动
19. 接入 QQ视频-爱玩 活动
20. 增加微信签到的每日签到提示
21. 增加部分需要手动参与的活动的提示
22. 增加部分会员联动活动的提示
23. 如需购买自动更新DLC或按月付费，请在配置工具的【付费相关】标签页自助购买，具体流程请查阅目录中【付费指引.docx】
24. 其他改动及上述功能具体用法，详见README.MD和CHANGELOG.MD以及使用教程/使用文档.docx和教程视频
