...
1. 新增 QQ视频-爱玩 活动
2. 增加部分需要手动领取的活动的提示
3. 新增 集卡 活动（旧版集卡移除，18号到期，如需继续做，请额外运行旧版本或者手动做）
4. 新增 DNF黄钻 活动
5. 新增 DNF超级会员 活动
6. 新增管家蚊子腿
7. 调整集卡抽奖的逻辑，改成一轮轮抽，确保在有抽奖上限次数时，剩余卡片是均匀分布的
8. 集卡抽奖达到上限时停止后续抽奖
9. 新增colg投票活动提示
10. 调整编年史抽奖的日志，并完善出错时的提示语
11. 漫画活动新增33-60集的奖励id
12. 新增 DNF珍贵记录 活动
13. 新增 关怀礼包 活动
14. 新增 DNF娱乐赛 活动
15. 新增 DNF F1天王赛 活动
16. 添加 新版wegame 活动（的雏形和提示）
17. 登录时增加打印登录链接，方便调试
18. 调整在指定服务器未查询到角色时的提示
19. 如需购买自动更新DLC或按月付费，请在配置工具的【付费相关】标签页自助购买，具体流程请查阅目录中【付费指引.docx】
20. 其他改动及上述功能具体用法，详见README.MD和CHANGELOG.MD以及使用教程/使用文档.docx和教程视频
