class Urls:
    def __init__(self):
        ...
        # qq视频活动
        self.qq_video = "https://activity.video.qq.com/fcgi-bin/asyn_activity?type={type}&option={option}&act_id={act_id}&module_id={module_id}&ptag=&otype=xjson&_ts={millseconds}"
