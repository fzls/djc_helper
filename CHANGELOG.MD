...
2. 开放闪光杯第三期功能
3. 移除过期的嘉年华活动
4. 每周一弹出打赏图片前，额外弹出一段话，显示累积使用时长，以及说明信息
5. 推荐使用使用autojs来自动完成助手编年史中的助手app相关任务、微信签到和2020DNF嘉年华派送好礼、hello语音活动等目前小助手无法直接支持的流程
6. 具体操作可参考[脚本源码](https://github.com/fzls/autojs) 以及 [演示视频](https://www.bilibili.com/video/BV1az4y1k7bH/)
