# 更新公告
1. 修复因蓝奏云下载文件的问题导致查询付费信息会出错的问题（请手动下载这个版本）
2. 新增账号级别配置，是否仅使用配置中设定的心悦操作，若设定为true，则不会在运行时将所有心悦任务都尝试完成一遍
3. 增加同步到gitee的action
4. 管家蚊子腿已过期
5. 增加 黑鸦落地页 活动
6. 适配 新的DNF福利中心兑换和登录 活动
7. 接入 新集卡 活动
8. 接入 福签大作战 活动
9. 新增 DNF黑鸦竞速 活动
10. 新增 dnf集合站 活动
11. 新增 wegame 活动
12. 新增带GUI的配置工具
13. 如需购买自动更新DLC或按月付费，请查阅目录中【付费指引v20210209.docx】(日期可能随版本变动)
