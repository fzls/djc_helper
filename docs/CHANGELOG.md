# 更新公告
1. 更新黑名单。请 79***35 停止使用本工具。问完问题就来一句，那你没用了。我不欢迎没有基本礼貌的人使用本工具，请你立刻停止使用本工具。否则，我默认你每使用一次，就是在对自己说：那你没用了。
2. 新增 DNF嘉年华预约 活动
3. 修正因心悦会员活动页面登录窗口不再自动弹出而导致原有登录流程无法生效的问题
4. 将修改标题框的流程往前移，放到切换登录框之前
