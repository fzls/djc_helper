...
4. 新增 集卡 活动
5. 新增 SVIP 活动
6. 若当前版本已发布超过14天，则在标题栏中增加显示距离下个活动周期预计剩余的时间
7. 版本时间过久的保底提示中增加展示下次活动的预估时间信息
8. 运行结束的时候，增加列出未来一年内各种常规活动周期的预估时间信息
9. 配置工具标题栏也增加活动预估信息
10. 心悦兑换的神器装扮属性调整箱已被移除，做下对应处理
11. 移除过时的提示
12. 如需购买自动更新DLC或按月付费，请在配置工具的【付费相关】标签页自助购买，具体流程请查阅目录中【付费指引.docx】
13. 其他改动及上述功能具体用法，详见README.MD和CHANGELOG.MD以及使用教程/使用文档.docx和教程视频
