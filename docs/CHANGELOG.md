...
3. 增加启用和废弃集卡活动的流程说明
4. 调整抽卡奖励的配置方式，改为配置是否领取，具体领取内容根据活动配置自动解析
5. 功能开关开启和关闭增加更明确的说明和示例
6. 由于经常有人把集卡赠送目标、赛利亚拜访目标、心悦固定队成员等QQ号数组填成数字数组，导致后续逻辑中由于类型不匹配而无法正常处理，这里兼容下，在读取完配置后都将其强制转换为字符串数组
7. 增加setting模块
8. 更新心悦活动备注，调整默认配置中的心悦操作，增加各种兑换道具的示例，默认不开启
9. 增加打印运行耗时
10. 赠送卡牌的时候额外打印一下进度，更加直观
11. 文档增加关闭功能的说明
12. 文档增加拒绝抬杠声明
13. 文档调整配置账号和手游的层级
14. 其他软件中增加autojs脚本的说明
15. 更新readme
16. 推荐使用使用autojs来自动完成助手编年史中的助手app相关任务、微信签到和2020DNF嘉年华派送好礼、hello语音活动等目前小助手无法直接支持的流程
17. 具体操作可参考[脚本源码](https://github.com/fzls/autojs) 以及 [演示视频](https://www.bilibili.com/video/BV1az4y1k7bH/)
