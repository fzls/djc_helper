...
not_ams_activities = [
    ...
    newNotAmsActInfo("2022-04-27 00:00:00", "2022-05-27 23:59:59", "qq视频蚊子腿-爱玩"),
    ...
    newNotAmsActInfo("2021-04-21 00:00:00", "2022-05-21 23:59:59", "黄钻"),
...
class Urls:
    def __init__(self):
        ...
        self.ide_iActivityId_majieluo = "61_9z4D10"  # DNF马杰洛的规划
        ...
        # 账号绑定信息
        self.dnf_helper_chronicle_binding = "https://mwegame.qq.com/yoyo/dnf/getcheatguardbinding"
        # 新版接口
