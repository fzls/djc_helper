# 更新公告
1. 移除过期活动
2. 处理重命名chrome_driver时，旧文件已经存在的情况
3. 增加处理dlc文件因下载失败等原因而是空文件的情况
4. 下载chrome相关文件时，增加提示若速度太慢则可以去群文件中手动下载
5. dlc下载完整包之前增加提示可能速度会很慢，提示等不及的话可以自行下载
6. 打包时的文档改为使用在线文档，减小打包大小
7. chrome相关文件增加尝试从github下载的方案
