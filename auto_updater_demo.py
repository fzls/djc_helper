...
def demo():
    ...
    p = subprocess.Popen([
        ...
        "--cwd", os.getcwd(),
        "--exe_name", os.path.realpath("DNF蚊子腿小助手.exe"),
    ...
    if p.returncode != 0:
        ...
        if latest_version_time > last_modify_time:
            logger.info(f"网盘中最新版本dlc上传于{latest_version_time}左右，在当前版本最后修改时间{last_modify_time}之后，有可能已经修复dlc的该问题，将尝试更新dlc为最新版本")
