# 更新公告
1. 新增马杰洛第三期
2. 增加新春福袋大作战的赠送功能，但是由于会真的发消息给对方（这次真的是真的），所以请自行探索配置方式，若无头绪则可当这个功能不存在
3. 首次运行新春福袋大作战时弹出福袋提示框
4. 各个活动统一增加try except装饰器保护，从而避免单个活动的问题导致其他活动也无法运行
5. try_except判断一些常见的错误，并增加更容易理解的补充说明
6. 新增付费获取的DLC：自动更新功能（未购买则保持与之前版本的更新流程一致）。目前定价10.24元，[演示视频](https://www.bilibili.com/video/BV1FA411W7Nq)，有需要的朋友可以扫码付款后QQ私聊我发付款截图获取自动更新工具0-0
7. 新增付费获取的集卡特别版DLC，仅包含集卡相关功能（集卡、送卡、展示卡片信息、兑换卡片奖励、使用卡片抽奖），供某些只需要集卡的朋友使用。定价6.66元，[演示视频](https://www.bilibili.com/video/BV1zA411H7mP)，有需求的朋友可以扫码付款后QQ私聊我发付款截图获取ヾ(=･ω･=)o
