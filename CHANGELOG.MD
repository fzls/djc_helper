# 更新公告
1. 点击微信支付按钮时提示渠道维护，提示使用支付宝或QQ钱包，或者切换卡密支付
2. 增加按月份保存编年史的进度信息，为日后可能有的添加自动匹配搭档功能增加数据支持（可能会在下个月加入，条件大概是上个月编年史达到30级满级）
3. 更新编年史任务列表
4. 移除过期的集卡活动
5. 新增编年史自动绑定固定搭档的功能（需配置固定搭档id）
6. 编年史增加显示搭档的等级概览
7. 若已绑定搭档，则个人概览增加展示队友的进度信息
8. dnf助手编年史token不对或者过期时，不再尝试后续的等级奖励领取
9. 个人概览中心悦自动匹配的状态区分是否匹配成功
10. 如需购买自动更新DLC或按月付费，请使用配置工具的卡密购买功能，具体流程请查阅目录中【付费指引v20210209.docx】(日期可能随版本变动)
