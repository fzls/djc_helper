...
2. 新增 新的会员关怀活动（新春关怀送好礼 助力男法师三觉）
3. 调整爆竹活动分享任务，每次需要分享不同的好友（不会实际发送消息）
4. 重构会员关怀活动，简化接入新关怀活动流程
5. 兼容下心悦信息查不到的情况
...
8. 本轮集卡我又换完啦，有需要买卡的朋友可私聊我购买~依旧是一元一张任意卡，先问下有没有卡，得到确定回复后直接发付款截图和要收卡片的QQ号码即可（不需要加好友）
