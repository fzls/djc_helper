...
def main():
    ...
    # note: 在这里添加公告
    title = "关于 勇士的好运盆栽 活动 v2"
    message = """如果助手token【正确配置】了，比如编年史的等级奖励也可以自动领取了，但这个盆栽活动仍无法领取，几乎可以百分百确定是你运行小助手时不符合领取资格。
这个活动需要登录后才能领取，与30分钟在线的签到一样，需要切换频道后才会刷新，否则，领取时会有下面这样的报错
【今日尚未登录游戏,若已登录过游戏请退出重新登录后再来抽奖!】
"""
    open_url = ""
    show_only_before_version = ""
