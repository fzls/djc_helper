...
6. 新增 集卡 活动
7. 补充说明编年史的兑换顺序
8. 编年史兑换将设置了兑换次数的放到前面
9. 更新默认的道聚城兑换配置
10. 运行结束时增加一个title提示
11. 个人概览中移除过期的dnf助手活动完成次数
12. 心悦闪光杯增加补签前两天的流程，确保漏签时也可以补回来
13. （小广告）前两周开始研究青龙面板白嫖京东的京豆和红包，目前已经基本把该踩的坑都踩完了，感觉还不错，两周下来领了接近100的京东和一百多的红包（换了90QB），有兴趣的朋友可以加小群 657921324 来一起白嫖（密码 风之凌殇），目前还有91个位置，先到先得哇0-0
